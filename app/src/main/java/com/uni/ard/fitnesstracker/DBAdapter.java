...
public class DBAdapter {
    ...
    public DBAdapter open() throws SQLException {
        ...
        if(!fetchTreats().isFirst()){
            Bitmap bm;
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.burger);
            insertTreat("Burger", bm, 295);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.cake_slice);
            insertTreat("Cake Slice", bm, 371);
            ...
            insertTreat("Chocolate Bar", bm, 235);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.chocolates);
            insertTreat("Chocolates", bm, 899);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.cocktail);
            insertTreat("Cocktail", bm, 163);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.cupcake);
            insertTreat("Cupcake", bm, 295);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.doughtnut);
            insertTreat("Doughnut", bm, 452);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.hotdog);
            insertTreat("Hotdog", bm, 315);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.ice_cream);
            insertTreat("Ice Cream", bm, 216);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.ice_lolly);
            insertTreat("Ice Lolly", bm, 61);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.martini);
            insertTreat("Martini", bm, 200);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.pancakes);
            insertTreat("Pancakes", bm, 227);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.pastry);
            insertTreat("Pastry", bm, 406);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.pie);
            insertTreat("Pie", bm, 411);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.pizza);
            insertTreat("Pizza", bm, 266);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.popcorn);
            insertTreat("Popcorn", bm, 375);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.pretzel);
            insertTreat("Pretzel", bm, 380);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.sundae);
            insertTreat("Sundae", bm, 180);
            bm = BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.waffles);
            insertTreat("Waffles", bm, 291);
        }
        return this;
    }
